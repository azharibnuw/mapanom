        ...
        <div class="row align-items-md-center">
            <div class="col-lg-4 col-md-4 col-sm-12 order-md-2">
                <div class="footer-logo text-sm-center">
                    <img src="{{ asset('frontafs/images/footer-logo.png') }}" alt="footer-logo">
                </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-3 widget-area">
                <div class="widget widget_text clearfix">
                    ...
                    <ul class="widget-post ttm-recent-post-list">
                        <li>
                            <a href="single-blog.html"><img src="{{ asset('frontafs/images/vector_page/post-001-654x490.jpg') }}" alt="post-img"></a>
                        ...
                        <li>
                            <a href="single-blog.html"><img src="{{ asset('frontafs/images/vector_page/post-002-654x490.jpg') }}" alt="post-img"></a>
                        ...
                        <li>
                            <a href="single-blog.html"><img src="{{ asset('frontafs/images/vector_page/post-003-654x490.jpg') }}" alt="post-img"></a>
                ...
                <div class="text-md-right res-767-mt-10">
                    <div class="d-lg-inline-flex">
                        ...
                        <div class="float-md-right ml-20 res-767-ml-0">
                            <img src="{{ asset('frontafs/images/footer-payment-img.png') }}" alt="payment-img">
                        </div>
                    </div>
                </div>
            </div>
